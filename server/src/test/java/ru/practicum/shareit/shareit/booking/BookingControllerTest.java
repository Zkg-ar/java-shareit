...
public class BookingControllerTest {
    ...
    void setup() {
        mvc = MockMvcBuilders
                ...
                .build();
        itemDto = new ItemDto(1L, "ru/practicum/shareit/item", "description", true, 1L);
    ...
    void getBookingsOfOwnerWithStateAllTest() throws Exception {
        ...
        mvc.perform((get("/bookings/owner?from=2&size=2")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].booker.id", Matchers.is(bookingDto.getBooker().getId()), Long.class))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].item.id", Matchers.is(bookingDto.getItem().getId()), Long.class))
    ...
    void getBookingsOfCurrentUserWithStateRejectTest() throws Exception {
        ...
        when(bookingService.getAllBookingsOfCurrentUser(anyLong(),any(), anyInt(),anyInt()))
                .thenReturn(List.of(bookingDto));
